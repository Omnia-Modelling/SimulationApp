...
def app():
    ...
    This model uses a behaviour package bases on big human behaviour databases from different governmental institutes who have tracked peoples behaviour for research purposes.
    ...
    _All Rights Preserved to Omnia_
    """)
    return None